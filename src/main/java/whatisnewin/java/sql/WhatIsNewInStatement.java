...
{
  /**
   * Example call to new method {@link Statement#enquoteIdentifier}
   * @since 9
   * @see Statement#enquoteIdentifier
   */
  ...
  /**
   * Example call to new method {@link Statement#enquoteLiteral}
   * @since 9
   * @see Statement#enquoteLiteral
   */
  ...
  /**
   * Example call to new method {@link Statement#isSimpleIdentifier}
   * @since 9
   * @see Statement#isSimpleIdentifier
   */
