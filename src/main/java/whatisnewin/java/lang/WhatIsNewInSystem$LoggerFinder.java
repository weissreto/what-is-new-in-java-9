...
{
  /**
   * Example call to new method {@link LoggerFinder#getLogger}
   * @since 9
   * @see LoggerFinder#getLogger
   */
  ...
  /**
   * Example call to new method {@link LoggerFinder#getLocalizedLogger}
   * @since 9
   * @see LoggerFinder#getLocalizedLogger
   */
