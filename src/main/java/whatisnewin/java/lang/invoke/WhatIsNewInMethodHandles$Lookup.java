...
public final class WhatIsNewInMethodHandles$Lookup
{
  ...
  /**
   * Example call to new method {@link Lookup#dropLookupMode}
   * @since 9
  ...
  /**
   * Example call to new method {@link Lookup#findStaticVarHandle}
   * @since 9
   * @see Lookup#findStaticVarHandle
   */
  ...
  /**
   * Example call to new method {@link Lookup#defineClass}
   * @since 9
  ...
  /**
   * Example call to new method {@link Lookup#findVarHandle}
   * @since 9
   * @see Lookup#findVarHandle
   */
  ...
  /**
   * Example call to new method {@link Lookup#findClass}
   * @since 9
   * @see Lookup#findClass
   */
  ...
  /**
   * Example call to new method {@link Lookup#unreflectVarHandle}
   * @since 9
   * @see Lookup#unreflectVarHandle
   */
  ...
  /**
   * Example call to new method {@link Lookup#accessClass}
   * @since 9
   * @see Lookup#accessClass
   */
