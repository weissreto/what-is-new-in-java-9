...
public final class WhatIsNewInConfiguration
{
  ...
  /**
   * Example call to new method {@link Configuration#resolveAndBind}
   * @since 9
   * @see Configuration#resolveAndBind
   */
  ...
  /**
   * Example call to new method {@link Configuration#findModule}
   * @since 9
   * @see Configuration#findModule
   */
  ...
  /**
   * Example call to new method {@link Configuration#resolve}
   * @since 9
