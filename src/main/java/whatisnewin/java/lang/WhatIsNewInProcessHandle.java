...
public final class WhatIsNewInProcessHandle
{
  ...
  /**
   * Example call to new method {@link ProcessHandle#of}
   * @since 9
   * @see ProcessHandle#of
   */
  ...
  /**
   * Example call to new method {@link ProcessHandle#compareTo}
   * @since 9
   * @see ProcessHandle#compareTo
   */
