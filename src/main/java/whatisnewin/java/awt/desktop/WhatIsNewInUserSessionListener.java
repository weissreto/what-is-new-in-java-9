...
{
  /**
   * Example call to new method {@link UserSessionListener#userSessionDeactivated(UserSessionEvent)}.
   * @since 9
  ...
  /**
   * Example call to new method {@link UserSessionListener#userSessionActivated(UserSessionEvent)}.
   * @since 9
