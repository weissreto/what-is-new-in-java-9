...
{
  /**
   * Example call to new method {@link LongStream#iterate}
   * @since 9
  ...
  /**
   * Example call to new method {@link LongStream#takeWhile}
   * @since 9
   * @see LongStream#takeWhile
   */
  ...
  /**
   * Example call to new method {@link LongStream#dropWhile}
   * @since 9
   * @see LongStream#dropWhile
   */
