...
{
  /**
   * Example call to new method {@link LogManager#addConfigurationListener}
   * @since 9
   * @see LogManager#addConfigurationListener
   */
  ...
  /**
   * Example call to new method {@link LogManager#updateConfiguration}
   * @since 9
   * @see LogManager#updateConfiguration
   */
