...
{
  /**
   * Example call to new method {@link URLConnection#setDefaultUseCaches}
   * @since 9
   * @see URLConnection#setDefaultUseCaches
   */
  ...
  /**
   * Example call to new method {@link URLConnection#getDefaultUseCaches}
   * @since 9
