...
public final class WhatIsNewInSettingControl
{
  ...
  /**
   * Example call to new method {@link SettingControl#combine}
   * @since 9
   * @see SettingControl#combine
   */
  ...
  /**
   * Example call to new method {@link SettingControl#setValue}
   * @since 9
   * @see SettingControl#setValue
   */
