...
{
  /**
   * Example call to new method {@link EventSettings#withPeriod}
   * @since 9
   * @see EventSettings#withPeriod
   */
  ...
  /**
   * Example call to new method {@link EventSettings#withThreshold}
   * @since 9
   * @see EventSettings#withThreshold
   */
  ...
  /**
   * Example call to new method {@link EventSettings#with}
   * @since 9
   * @see EventSettings#with
   */
