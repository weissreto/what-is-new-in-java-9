...
public final class WhatIsNewInFlightRecorder
{
  ...
  /**
   * Example call to new method {@link FlightRecorder#addPeriodicEvent}
   * @since 9
   * @see FlightRecorder#addPeriodicEvent
   */
  ...
  /**
   * Example call to new method {@link FlightRecorder#register}
   * @since 9
   * @see FlightRecorder#register
   */
  ...
  /**
   * Example call to new method {@link FlightRecorder#addListener}
   * @since 9
   * @see FlightRecorder#addListener
   */
  ...
  /**
   * Example call to new method {@link FlightRecorder#removePeriodicEvent}
   * @since 9
   * @see FlightRecorder#removePeriodicEvent
   */
  ...
  /**
   * Example call to new method {@link FlightRecorder#removeListener}
   * @since 9
   * @see FlightRecorder#removeListener
   */
  ...
  /**
   * Example call to new method {@link FlightRecorder#unregister}
   * @since 9
   * @see FlightRecorder#unregister
   */
