...
public final class WhatIsNewInDocletEnvironment
{
  ...
  /**
   * Example call to new method {@link DocletEnvironment#isSelected}
   * @since 9
   * @see DocletEnvironment#isSelected
   */
  ...
  /**
   * Example call to new method {@link DocletEnvironment#getFileKind}
   * @since 9
   * @see DocletEnvironment#getFileKind
   */
  ...
  /**
   * Example call to new method {@link DocletEnvironment#isIncluded}
   * @since 9
   * @see DocletEnvironment#isIncluded
   */
