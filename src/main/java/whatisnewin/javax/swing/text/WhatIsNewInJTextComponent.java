...
{
  /**
   * Example call to new method {@link JTextComponent#modelToView2D(int)}.
   * @since 9
   * @see JTextComponent#modelToView2D(int)
   */
  ...
  /**
   * Example call to new method {@link JTextComponent#viewToModel2D(Point2D)}.
   * @since 9
   * @see JTextComponent#viewToModel2D(Point2D)
   */
