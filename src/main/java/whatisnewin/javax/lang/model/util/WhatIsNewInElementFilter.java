...
public final class WhatIsNewInElementFilter
{
  ...
  /**
   * Example call to new method {@link ElementFilter#usesIn(Iterable)}.
   * @since 9
   * @see ElementFilter#usesIn(Iterable)
   */
  public static List<UsesDirective> usesIn(Iterable<? extends Directive> directives)
  {
    List<UsesDirective> result = ElementFilter.usesIn(directives);
    return result;
  }
