...
{
  /**
   * Example call to new method {@link SSLParameters#setEnableRetransmissions}
   * @since 9
   * @see SSLParameters#setEnableRetransmissions
   */
  ...
  /**
   * Example call to new method {@link SSLParameters#setMaximumPacketSize}
   * @since 9
   * @see SSLParameters#setMaximumPacketSize
   */
