...
public final class WhatIsNewInTIFFImageReadParam
{
  ...
  /**
   * Example call to new method {@link TIFFImageReadParam#addAllowedTagSet}
   * @since 9
   * @see TIFFImageReadParam#addAllowedTagSet
   */
  ...
  /**
   * Example call to new method {@link TIFFImageReadParam#removeAllowedTagSet}
   * @since 9
   * @see TIFFImageReadParam#removeAllowedTagSet
   */
  ...
  /**
   * Example call to new method {@link TIFFImageReadParam#setReadUnknownTags}
   * @since 9
   * @see TIFFImageReadParam#setReadUnknownTags
   */
