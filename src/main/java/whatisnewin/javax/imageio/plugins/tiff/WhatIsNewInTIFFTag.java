...
public final class WhatIsNewInTIFFTag
{
  ...
  /**
   * Example call to new constructor {@link TIFFTag#TIFFTag}
   * @since 9
   * @see TIFFTag#TIFFTag
   */
  ...
  /**
   * Example call to new method {@link TIFFTag#isDataTypeOK}
   * @since 9
   * @see TIFFTag#isDataTypeOK
   */
  ...
  /**
   * Example call to new method {@link TIFFTag#getValueName}
   * @since 9
   * @see TIFFTag#getValueName
   */
  ...
  /**
   * Example call to new method {@link TIFFTag#getSizeOfType}
   * @since 9
   * @see TIFFTag#getSizeOfType
   */
